...
fn main() {
    eprintln!("resize_demo requires macOS (uses CAMetalLayer).");
}
    ...
    unsafe fn clear_frame(
        ...
        unsafe {
            ...
            let attachment: *mut AnyObject =
                msg_send![attachments, objectAtIndexedSubscript: 0_u64];
            ...
            let encoder: *mut AnyObject =
                msg_send![cmdbuf, renderCommandEncoderWithDescriptor: rpd];
